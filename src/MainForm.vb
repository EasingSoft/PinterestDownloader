...
Public Class MainForm
    ...
    Async Sub DownlaodBtn_Click(sender As Object, e As EventArgs) Handles DownlaodBtn.Click
        ...
        If Await RefreshGridIfNeeded() Then
    ...
    Private Function GetPreviewImageLink(images As Object) As String
        If images.orig IsNot Nothing Then Return images.orig.url
        If images.p736x IsNot Nothing Then Return images.p736x.url
        If images.p474x IsNot Nothing Then Return images.p474x.url
        If images.p236x IsNot Nothing Then Return images.p236x.url
        If images.p170x IsNot Nothing Then Return images.p170x.url
        Return String.Empty
    End Function

    Private Function GetOriginalImageLink(Item As Object) As String
        If Item.image236x IsNot Nothing Then Return Item.image236x.url
        If Item.image474x IsNot Nothing Then Return Item.image474x.url
        If Item.image564x IsNot Nothing Then Return Item.image564x.url
        If Item.image736x IsNot Nothing Then Return Item.image736x.url
        Return String.Empty
    End Function

    Private Function GetVideoLink(videos As Object) As String
        If videos IsNot Nothing AndAlso videos.video_list IsNot Nothing Then
